...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Lectura interactiva de runas del Futhark Antiguo basada en el libro El Camino de las Runas. Tres Nornas, Cruz Celta, Árbol de la Vida y Pareja." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Runas Ancestrales · Oráculo del Futhark Antiguo" },
      { name: "twitter:description", content: "Lectura interactiva de runas del Futhark Antiguo basada en el libro El Camino de las Runas. Tres Nornas, Cruz Celta, Árbol de la Vida y Pareja." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6f86cb77-6e74-49df-a3aa-4a414f698cd1/id-preview-08a0c823--1a702e3e-6de7-4e47-943f-01055ed505e4.lovable.app-1779313818521.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6f86cb77-6e74-49df-a3aa-4a414f698cd1/id-preview-08a0c823--1a702e3e-6de7-4e47-943f-01055ed505e4.lovable.app-1779313818521.png" },
