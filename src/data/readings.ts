...
export const READINGS: ReadingType[] = [
  ...
  },
  {
    ...
    shape: "tree",
    positions: [
      { name: "Espíritu · Pasado", x: 1, y: 1, meaning: "Lo que tu espíritu trae como herencia, la inspiración recibida en otros tiempos." },
      { name: "Espíritu · Presente", x: 2, y: 1, meaning: "La chispa divina que arde en ti ahora, lo que el cielo te susurra." },
      { name: "Espíritu · Futuro", x: 3, y: 1, meaning: "El destino que se revela en lo alto, aquello que viene desde los dioses." },
      { name: "Mente · Pasado", x: 1, y: 2, meaning: "Pensamientos y decisiones que marcaron el camino hasta aquí." },
      { name: "Mente · Presente", x: 2, y: 2, meaning: "Aquello que ocupa tu mente y tu corazón en este instante." },
      { name: "Mente · Futuro", x: 3, y: 2, meaning: "Hacia dónde se dirigen tus pensamientos y emociones." },
      { name: "Cuerpo · Pasado", x: 1, y: 3, meaning: "Los hechos y acciones del ayer, lo material ya tejido." },
      { name: "Cuerpo · Presente", x: 2, y: 3, meaning: "La realidad concreta que vives hoy, lo que toca tu día a día." },
      { name: "Cuerpo · Futuro", x: 3, y: 3, meaning: "El resultado tangible, la cosecha que se aproxima." },
    ],
  },
];
